...
CREATE INDEX IF NOT EXISTS idx_licenses_created_at_desc ON licenses (created_at DESC);
CREATE INDEX IF NOT EXISTS idx_licenses_status_created_at_desc_active
  ON licenses (status, created_at DESC)
  WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_licenses_import_registry_status ON licenses (import_registry_status);
CREATE INDEX IF NOT EXISTS idx_licenses_registry_inactive ON licenses (import_registry_inactive);
...
CREATE INDEX IF NOT EXISTS idx_email_action_tokens_user_action ON email_action_tokens (user_id, action_type);
