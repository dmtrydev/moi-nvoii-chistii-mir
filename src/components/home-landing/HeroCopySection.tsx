export function HeroCopySection(): JSX.Element {
  return (
    <div className="relative mx-auto mt-6 flex w-full max-w-[min(1184px,calc(100%-2rem))] flex-col items-center gap-4 px-4 text-center sm:mt-8 sm:gap-5 md:mt-10 md:px-6 lg:mt-[clamp(3rem,8vw,11.5rem)]">
      <h1 className="typo-h1 relative mt-[-1px] max-w-[min(1184px,100%)] bg-[linear-gradient(136deg,rgba(43,51,53,1)_0%,rgba(97,110,114,1)_47%,rgba(43,51,53,1)_100%)] bg-clip-text text-transparent [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] [text-fill-color:transparent]">
