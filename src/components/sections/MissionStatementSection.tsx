...
export function MissionStatementSection(): JSX.Element {
  return (
    <section
      className="items-center justify-center px-0 py-[130px] bg-[#f2f8f5] flex relative self-stretch w-full flex-[0_0_auto]"
      ...
      <div className="max-w-[1510px] w-full justify-center px-[50px] py-0 flex items-center relative">
        <RevealOnScroll variant="reveal-scale" className="flex flex-col items-center justify-center gap-[60px] px-0 py-[100px] relative flex-1 grow">
          <div className="flex flex-col max-w-[780px] w-full items-center justify-center gap-5 relative flex-[0_0_auto]">
            <div className="flex self-stretch w-full flex-[0_0_auto] flex-col items-start relative">
              <div className="relative self-stretch w-full h-[420px]">
                <h1
                  id="mission-heading"
                  className="absolute top-0 left-[calc(50.00%_-_385px)] w-[789px] h-[168px] [font-family:'Inter-Medium',Helvetica] font-medium text-transparent text-[70px] text-center tracking-[-0.70px] leading-[84px]"
                >
                  ...
                  <span className="text-[#4f7363] tracking-[-0.49px]">
                    innovative,
                  </span>
                </h1>

                <p className="absolute top-[168px] left-[calc(50.00%_-_369px)] w-[756px] h-[168px] text-transparent text-center [font-family:'Inter-Medium',Helvetica] font-medium text-[70px] tracking-[-0.70px] leading-[84px]">
                  <span className="text-[#4f7363] tracking-[-0.49px]">
                ...
                <p className="absolute top-[336px] left-[calc(50.00%_-_272px)] w-[544px] h-[84px] flex items-center justify-center [font-family:'Inter-Medium',Helvetica] font-medium text-[#151e1b] text-[70px] text-center tracking-[-0.70px] leading-[84px] whitespace-nowrap">
                  and green living.
                </p>
              </div>
            </div>
          ...
          <div className="inline-flex flex-col items-start relative flex-[0_0_auto]">
            <a
              className="inline-flex flex-col items-center justify-center px-[30px] py-5 relative flex-[0_0_auto] bg-[#4f7363] rounded-[60px] hover:bg-[#3f5d51] transition-colors focus:outline-none focus:ring-2 focus:ring-[#4f7363] focus:ring-offset-2"
              href="https://greenx-template.framer.website/about-us"
