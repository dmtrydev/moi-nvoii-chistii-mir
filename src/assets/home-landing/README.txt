...
На каждый из 6 слотов — ДВА файла: активный и неактивный.
В каждом SVG должна быть полная картинка кнопки (круг/градиент + иконка): в React больше НЕ рисуется второй круг, чтобы не было «иконки в иконке».
Рекомендуемый размер артборда — квадрат, например 40×40 или 55×55 px.
